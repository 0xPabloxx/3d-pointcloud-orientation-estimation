            ...
            dbc.Row([
                ...
                dbc.Col([
                    ...
                    html.Div([
                        ...
                        dbc.Button("完全对称", id="btn-k0", color="primary", className="w-100 mb-1", size="sm"),
                        dbc.Button("没有正面", id="btn-k-none", color="primary", className="w-100 mb-1", size="sm"),
                    ]),
        ...
        def handle_all_interactions(*args):
            ...
            if front_direction and front_direction != '-Z':
                ...
                fig_corrected.update_layout(
                    margin=dict(l=0, r=0, t=30, b=0),
                    title=dict(text="等待标注...", font=dict(size=12))
                )
            ...
            return (fig_original, fig_corrected, progress, status, save_msg,
                    current_idx, category_options, category_progress_display)
